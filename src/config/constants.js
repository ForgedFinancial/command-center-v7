...
export const AGENT_HIERARCHY = {
  ...
  architect: { id: 'architect', name: 'Soren', role: 'The Planner', description: 'System design, build plans, requirements, research', isHuman: false, parent: 'clawd', model: 'gpt-5.3-codex', designation: 'FF-PLN-001' },
  ...
  kyle: { id: 'kyle', name: 'Kyle', role: 'Desktop Agent', description: 'Windows desktop agent — local files, browser, system access on Divine-Download. Online when Boss is at his desk.', isHuman: false, parent: 'clawd', model: 'gpt-3.5-turbo', designation: 'CC-DSK-001', online: 'conditional' },
