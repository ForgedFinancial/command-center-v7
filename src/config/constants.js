...
export const AGENT_HIERARCHY = {
  ...
  kyle: { id: 'kyle', name: 'Kyle', role: 'Desktop Agent', description: 'Windows desktop agent — local files, browser, system access on Divine-Download. Online when Boss is at his desk.', isHuman: false, parent: 'clawd', model: 'openai-o3', designation: 'CC-DSK-001', online: 'conditional' },
