...
export default function BoardCanvas({ viewport, onPointerDown, onPointerMove, onPointerUp, onWheel, items, selectedIds, onItemPointerDown, onHandlePointerDown, onRotatePointerDown, onItemContentChange, selectionBox }) {
