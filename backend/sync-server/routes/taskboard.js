...
router.post('/tasks', async (req, res) => {
  try {
    ...
    const task = {
      ...
      canvasItemId: req.body.canvasItemId || null,
      isProjectTask: req.body.isProjectTask || false,
      sourceType: req.body.sourceType || null,
      sourceId: req.body.sourceId || null,
      isProjectParentTask: Boolean(req.body.isProjectParentTask),
...
router.post('/projects', async (req, res) => {
  try {
    ...
    const project = {
      ...
      workspacePosition: req.body.workspacePosition || null,
      parentProjectId: req.body.parentProjectId || null,
      isTaskified: req.body.isTaskified || false,
      parentTaskId: req.body.parentTaskId || null,
...
router.post('/canvas-objects', async (req, res) => {
  try {
    ...
    const obj = {
      ...
      projectId: req.body.projectId || req.body.data?.projectId || null,
      canvasScope: req.body.canvasScope || req.body.data?.canvasScope || 'outer',
      data: req.body.data || {},
      createdAt: now(),
      updatedAt: now(),
    }
